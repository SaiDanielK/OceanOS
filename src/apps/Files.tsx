...
export default function Files() {
	const openMusicFile = useDesktopStore(
		(state) => state.openMusicFile
	);

	const openVideoFile = useDesktopStore(
		(state) => state.openVideoFile
	);

	const openImageFile = useDesktopStore(
		(state) => state.openImageFile
	);

	const openNoteFile = useDesktopStore(
		(state) => state.openNoteFile
	);
